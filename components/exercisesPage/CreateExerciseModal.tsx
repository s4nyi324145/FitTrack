      ...
      <div className="flex flex-col border-2 border-border bg-surface max-w-[600px] w-full max-h-[90vh] overflow-y-auto rounded-xl">
        ...
        <div className="flex justify-center  gap-6 p-6">
          ...
          {loading ? (
            <button
              disabled={loading
}              className="flex flex-1 justify-center cursor-pointer hover:bg-surface-raised transition-all rounded-md p-2 bg-primary/50 border border-primary text-white"
            >
              Creating...
            </button>
          ) : (
            <button
              ...
              disabled={loading}
              className="flex flex-1 justify-center cursor-pointer hover:bg-primary-hover transition-all rounded-md p-2 bg-primary border border-primary text-white"
            >
              Create Exercise
            </button>
          )}
